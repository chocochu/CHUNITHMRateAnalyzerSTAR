...
var CHART_LIST = [
    ...
    { id:  18, difficulty: { expert:  8.4, master: 11.4 }, name: "千本桜" },
    { id:  19, difficulty: { expert: 11.4, master: 13.2 }, name: "DRAGONLADY" },
    { id:  20, difficulty: {               master: 12.8 }, name: "taboo tears you up" },
    { id:  21, difficulty: { expert:  9.0, master: 11.9 }, name: "ナイト・オブ・ナイツ" },
    { id:  23, difficulty: {               master: 12.1 }, name: "一触即発☆禅ガール" },
    { id:  24, difficulty: { expert:  9.5, master: 12.7 }, name: "ドーナツホール" },
    { id:  27, difficulty: { expert:  9.9, master: 12.5 }, name: "タイガーランペイジ" },
    { id:  28, difficulty: { expert:  8.5, master: 10.7 }, name: "Pursuing My True Self" },
    { id:  33, difficulty: { expert:  9.8, master: 13.1 }, name: "Blue Noise" },
    { id:  34, difficulty: { expert:  9.2, master: 12.2 }, name: "亡國覚醒カタルシス" },
    { id:  35, difficulty: {               master: 12.4 }, name: "Lapis" },
    { id:  36, difficulty: {               master: 11.0 }, name: "届かない恋 '13" },
    { id:  37, difficulty: { expert:  8.5, master: 11.3 }, name: "鳥の詩" },
    { id:  38, difficulty: { expert:  8.6, master: 11.1 }, name: "天ノ弱" },
    ...
    { id:  47, difficulty: { expert:  9.9, master: 12.3 }, name: "六兆年と一夜物語" },
    { id:  48, difficulty: {               master: 11.8 }, name: "Unlimited Spark!" },
    { id:  49, difficulty: { expert:  8.0, master: 10.0 }, name: "エピクロスの虹はもう見えない" },
    { id:  51, difficulty: { expert: 10.0, master: 12.8 }, name: "My First Phone" },
    { id:  52, difficulty: { expert: 11.1, master: 13.2 }, name: "Cyberozar" },
    { id:  53, difficulty: { expert: 10.0, master: 12.3 }, name: "Teriqma" },
    { id:  55, difficulty: { expert:  8.4, master: 11.2 }, name: "夏祭り" },
    ...
    { id:  68, difficulty: { expert:  8.8, master: 11.5 }, name: "乗り切れ受験ウォーズ" },
    { id:  69, difficulty: { expert: 11.9, master: 13.4 }, name: "The wheel to the right" },
    { id:  70, difficulty: { expert:  9.7, master: 12.4 }, name: "STAR" },
    { id:  71, difficulty: { expert:  9.9, master: 12.3 }, name: "Infantoon Fantasy" },
    { id:  72, difficulty: { expert: 10.0, master: 13.5 }, name: "Genesis" },
    { id:  73, difficulty: { expert: 10.4, master: 12.7 }, name: "MUSIC PЯAYER" },
    ...
    { id:  78, difficulty: { expert:  7.5, master: 11.0 }, name: "crossing field" },
    { id:  79, difficulty: { expert:  9.8, master: 11.1 }, name: "ＧＯ！ＧＯ！ラブリズム♥" },
    { id:  80, difficulty: { expert:  8.0, master: 10.5 }, name: "Grab your sword" },
    { id:  82, difficulty: { expert:  8.5, master: 12.5 }, name: "Memories of Sun and Moon" },
    { id:  83, difficulty: {               master: 12.2 }, name: "ロストワンの号哭" },
    { id:  88, difficulty: { expert: 10.0, master: 12.1 }, name: "The Concept of Love" },
    { id:  89, difficulty: { expert:  8.3, master: 11.0 }, name: "JET" },
    { id:  90, difficulty: { expert: 11.7, master: 13.5 }, name: "L'épisode" },
    { id:  91, difficulty: {               master: 11.2 }, name: "Yet Another ”drizzly rain”" },
    { id:  92, difficulty: { expert: 10.2, master: 13.0 }, name: "最終鬼畜妹・一部声" },
    { id:  93, difficulty: {               master: 12.3 }, name: "蒼空に舞え、墨染の桜" },
    { id:  94, difficulty: { expert:  8.3, master: 12.4 }, name: "セツナトリップ" },
    { id:  95, difficulty: {               master: 12.1 }, name: "砂漠のハンティングガール♡" },
    { id:  96, difficulty: { expert:  8.5, master: 11.9 }, name: "チルノのパーフェクトさんすう教室" },
    { id:  97, difficulty: { expert:  8.4, master: 10.8 }, name: "Help me, ERINNNNNN!!" },
    { id:  98, difficulty: { expert:  8.5, master: 11.4 }, name: "魔理沙は大変なものを盗んでいきました" },
    { id:  99, difficulty: {               master: 11.7 }, name: "言ノ葉カルマ" },
    { id: 100, difficulty: { expert:  8.1, master: 10.9 }, name: "After the rain" },
    ...
    { id: 104, difficulty: { expert: 10.2, master: 12.5 }, name: "とーきょー全域★アキハバラ？" },
    { id: 105, difficulty: {               master: 10.7 }, name: "overcome" },
    { id: 106, difficulty: { expert: 12.2, master: 13.8 }, name: "宛城、炎上！！" },
    { id: 107, difficulty: { expert: 10.2, master: 13.1 }, name: "We Gonna Journey" },
    { id: 108, difficulty: { expert: 10.2, master: 12.2 }, name: "The ether" },
    { id: 113, difficulty: { expert:  8.6, master: 11.4 }, name: "ストリーミングハート" },
    { id: 114, difficulty: {               master: 11.6 }, name: "Sweet Devil" },
    { id: 115, difficulty: { expert:  8.4, master: 11.5 }, name: "Dreaming" },
    { id: 116, difficulty: { expert:  7.9, master: 10.5 }, name: "君の知らない物語" },
    { id: 117, difficulty: {               master: 11.5 }, name: "M.S.S.Planet" },
    { id: 118, difficulty: { expert:  9.7, master: 12.0 }, name: "腐れ外道とチョコレゐト" },
    { id: 119, difficulty: {               master: 12.3 }, name: "アウターサイエンス" },
    { id: 120, difficulty: { expert:  8.4, master: 12.7 }, name: "四次元跳躍機関" },
    ...
    { id: 124, difficulty: { expert:  8.3, master: 12.2 }, name: "夏影" },
    { id: 125, difficulty: { expert:  8.4, master: 11.0 }, name: "Little Busters! ～TV animation ver.～" },
    { id: 126, difficulty: { expert:  8.3, master: 11.3 }, name: "Heart To Heart" },
    { id: 128, difficulty: { expert:  9.9, master: 12.7 }, name: "The Formula" },
    { id: 131, difficulty: { expert: 10.0, master: 12.7 }, name: "チルドレンレコード" },
    { id: 132, difficulty: {               master: 12.2 }, name: "イカサマライフゲイム" },
    { id: 133, difficulty: { expert:  7.6, master: 11.0 }, name: "シリョクケンサ" },
    { id: 134, difficulty: { expert: 12.2, master: 13.8 }, name: "HAELEQUIN (Original Remaster)" },
    { id: 135, difficulty: { expert: 10.1, master: 13.5 }, name: "Vallista" },
    ...
    { id: 150, difficulty: { expert: 10.0, master: 11.8 }, name: "brilliant better" },
    { id: 151, difficulty: {               master: 12.6 }, name: "Alma" },
    { id: 152, difficulty: { expert: 12.0, master: 13.0 }, name: "Gustav Battle" },
    { id: 154, difficulty: { expert: 10.0, master: 12.8 }, name: "SAVIOR OF SONG" },
    { id: 156, difficulty: { expert:  8.0, master: 11.4 }, name: "FREELY TOMORROW" },
    { id: 157, difficulty: { expert: 10.0, master: 12.9 }, name: "ギガンティックO.T.N" },
    ...
    { id: 165, difficulty: { expert:  9.7, master: 12.8 }, name: "ぼくらの16bit戦争" },
    ...
    { id: 169, difficulty: { expert: 10.0, master: 11.4 }, name: "elegante" },
    ...
    { id: 177, difficulty: { expert:  9.7, master: 12.7 }, name: "Jimang Shot" },
    { id: 178, difficulty: { expert: 10.0, master: 12.7 }, name: "stella=steLLa" },
    { id: 179, difficulty: { expert:  8.5, master: 11.3 }, name: "すろぉもぉしょん" },
    { id: 180, difficulty: { expert: 12.7, master: 14.0 }, name: "怒槌" },
    { id: 181, difficulty: { expert:  8.1, master: 10.8 }, name: "ユクエシレズ" },
    { id: 182, difficulty: { expert:  7.5, master: 10.1 }, name: "WHITE ALBUM Live at Campus Fes" },
    { id: 184, difficulty: { expert:  7.7, master: 10.0 }, name: "Last regrets" },
    { id: 185, difficulty: {               master: 11.2 }, name: "楽園の翼" },
    { id: 186, difficulty: { expert:  9.7, master: 11.9 }, name: "ってゐ！　～えいえんてゐVer～" },
    { id: 187, difficulty: { expert: 11.0, master: 13.1 }, name: "患部で止まってすぐ溶ける～狂気の優曇華院" },
    { id: 189, difficulty: { expert:  9.8, master: 12.7 }, name: "ひれ伏せ愚民どもっ！" },
    { id: 190, difficulty: { expert: 10.1, master: 12.6 }, name: "エテルニタス・ルドロジー" },
    { id: 191, difficulty: { expert:  8.4, master: 11.7 }, name: "幽闇に目醒めしは" },
    { id: 192, difficulty: {               master: 12.5 }, name: "Starlight Vision" },
    { id: 193, difficulty: { expert:  9.9, master: 12.5 }, name: "Club Ibuki in Break All" },
    { id: 194, difficulty: {               master: 13.0 }, name: "Phantasm Brigade" },
    { id: 195, difficulty: { expert:  8.5, master: 12.3 }, name: "永遠のメロディ" },
    ...
    { id: 198, difficulty: { expert: 11.7, master: 13.5 }, name: "AVALON" },
    { id: 199, difficulty: { expert: 10.0, master: 12.1 }, name: "ハート・ビート" },
    { id: 200, difficulty: { expert:  9.7, master: 12.1 }, name: "無敵We are one!!" },
    ...
    { id: 207, difficulty: { expert:  9.7, master: 11.7 }, name: "Your Affection (Daisuke Asakura Remix)" },
    { id: 208, difficulty: { expert: 10.0, master: 12.7 }, name: "SAMBISTA" },
    { id: 209, difficulty: {               master: 11.2 }, name: "君色シグナル" },
    { id: 210, difficulty: {               master: 12.4 }, name: "アスノヨゾラ哨戒班" },
    { id: 211, difficulty: { expert:  9.8, master: 12.2 }, name: "天樂" },
    ...
    { id: 225, difficulty: { expert:  9.9, master: 12.1 }, name: "ウミユリ海底譚" },
    { id: 226, difficulty: { expert: 12.3, master: 13.8 }, name: "Garakuta Doll Play" },
    { id: 227, difficulty: { expert:  8.5, master: 11.5 }, name: "洗脳" },
    { id: 228, difficulty: {               master: 12.0 }, name: "このふざけた素晴らしき世界は、僕の為にある" },
    { id: 229, difficulty: { expert: 12.0, master: 13.4 }, name: "紅華刑" },
    { id: 230, difficulty: { expert: 10.1, master: 12.5 }, name: "Hyperion" },
    { id: 231, difficulty: { expert:  8.3, master: 11.0 }, name: "カラフル。" },
    ...
    { id: 238, difficulty: { expert:  8.5, master: 11.9 }, name: "フレンズ" },
    { id: 240, difficulty: { expert: 10.1, master: 12.6 }, name: "夜咄ディセイブ" },
    { id: 243, difficulty: {               master: 12.2 }, name: "シュガーソングとビターステップ" },
    { id: 244, difficulty: { expert:  9.7, master: 12.3 }, name: "回レ！雪月花" },
    ...
    { id: 253, difficulty: { expert: 10.1, master: 13.1 }, name: "Warcry" },
    { id: 254, difficulty: {               master: 11.7 }, name: "その群青が愛しかったようだった" },
    { id: 255, difficulty: {               master: 11.0 }, name: "激情！ミルキィ大作戦" },
    { id: 256, difficulty: { expert: 10.2, master: 12.7 }, name: "札付きのワル　～マイケルのうた～" },
    { id: 257, difficulty: { expert: 10.2, master: 13.0 }, name: "BOKUTO" },
    ...
    { id: 261, difficulty: { expert:  9.7, master: 12.3 }, name: "ロボットプラネットユートピア" },
    ...
    { id: 265, difficulty: { expert:  9.9, master: 12.3 }, name: "猫祭り" },
    ...
    { id: 284, difficulty: { expert: 10.2, master: 12.7 }, name: "幸せになれる隠しコマンドがあるらしい" },
    { id: 286, difficulty: { expert:  8.6, master: 11.5 }, name: "Tell Your World" },
    { id: 287, difficulty: { expert: 10.0, master: 11.9 }, name: "ロミオとシンデレラ" },
    { id: 288, difficulty: {               master: 11.6 }, name: "First Twinkle" },
    { id: 289, difficulty: { expert: 10.7, master: 12.6 }, name: "ウソラセラ" },
    { id: 290, difficulty: { expert:  8.2, master: 11.3 }, name: "檄!帝国華撃団" },
    { id: 291, difficulty: { expert:  9.8, master: 12.4 }, name: "Kronos" },
    { id: 292, difficulty: { expert:  8.5, master: 12.1 }, name: "月に叢雲華に風" },
    { id: 293, difficulty: { expert: 10.8, master: 13.2 }, name: "インビジブル" },
    { id: 294, difficulty: { expert: 10.3, master: 12.8 }, name: "人生リセットボタン" },
    { id: 295, difficulty: { expert:  9.8, master: 12.0 }, name: "響" },
    ...
    { id: 304, difficulty: { expert:  8.4, master: 11.7 }, name: "In The Blue Sky '01" },
    { id: 305, difficulty: { expert: 11.0, master: 13.1 }, name: "幻想のサテライト" },
    { id: 306, difficulty: {               master: 12.2 }, name: "凛として咲く花の如く" },
    { id: 307, difficulty: { expert: 10.1, master: 12.7 }, name: "Paqqin" },
    ...
    { id: 313, difficulty: { expert:  8.5, master: 11.4 }, name: "ひだまりデイズ" },
    { id: 314, difficulty: {               master: 11.8 }, name: "This game" },
    { id: 315, difficulty: { expert:  8.6, master: 11.3 }, name: "オラシオン" },
    { id: 316, difficulty: {               master: 11.5 }, name: "みくみくにしてあげる♪【してやんよ】" },
    { id: 317, difficulty: { expert: 10.1, master: 13.4 }, name: "Air" },
    { id: 318, difficulty: { expert: 10.3, master: 13.0 }, name: "DataErr0r" },
    { id: 319, difficulty: { expert:  9.8, master: 12.7 }, name: "Say A Vengeance" },
    { id: 320, difficulty: { expert:  9.6, master: 12.6 }, name: "010" },
    ...
    { id: 324, difficulty: { expert: 10.0, master: 12.6 }, name: "STAGER" },
    ...
    { id: 330, difficulty: { expert:  9.7, master: 12.1 }, name: "ドキドキDREAM!!!" },
    { id: 331, difficulty: { expert:  9.8, master: 12.2 }, name: "猛進ソリストライフ！" },
    { id: 332, difficulty: {               master: 12.3 }, name: "空威張りビヘイビア" },
    { id: 334, difficulty: { expert: 10.0, master: 12.4 }, name: "FLOATED CALM" },
    ...
    { id: 338, difficulty: { expert:  9.8, master: 12.3 }, name: "SPICY SWINGY STYLE" },
    { id: 339, difficulty: {               master: 11.7 }, name: "RevolutionGame" },
    { id: 340, difficulty: {               master: 12.5 }, name: "Still" },
    { id: 341, difficulty: { expert:  9.9, master: 13.1 }, name: "おまかせ！！トラブルメイ娘☆とれびちゃん" },
    { id: 342, difficulty: { expert: 10.6, master: 13.4 }, name: "オススメ☆♂♀☆でぃすとぴあ" },
    { id: 343, difficulty: { expert:  8.5, master: 11.6 }, name: "Daydream café" },
    { id: 344, difficulty: { expert:  8.3, master: 11.8 }, name: "ノーポイッ!" },
    { id: 345, difficulty: { expert:  8.5, master: 11.7 }, name: "ムーンライト伝説" },
    ...
    { id: 353, difficulty: { expert:  8.4, master: 10.9 }, name: "H-A-J-I-M-A-R-I-U-T-A-!!" },
    ...
    { id: 357, difficulty: { expert:  8.3, master: 11.7 }, name: "ぐーちょきパレード" },
    { id: 358, difficulty: {               master: 11.7 }, name: "My Soul,Your Beats!" },
    { id: 359, difficulty: {               master: 11.8 }, name: "Thousand Enemies" },
    { id: 360, difficulty: { expert:  8.3, master: 11.3 }, name: "夢想歌" },
    { id: 362, difficulty: {               master: 12.1 }, name: "Face of Fact" },
    { id: 363, difficulty: { expert:  8.5, master: 11.6 }, name: "true my heart -Lovable mix-" },
    { id: 365, difficulty: { expert:  8.0, master: 10.9 }, name: "桜ノ雨" },
    { id: 367, difficulty: { expert:  8.4, master: 11.4 }, name: "いーあるふぁんくらぶ" },
    { id: 368, difficulty: { expert: 10.0, master: 12.8 }, name: "おこちゃま戦争" },
    ...
    { id: 372, difficulty: { expert:  8.2, master: 12.2 }, name: "すきなことだけでいいです" },
    { id: 373, difficulty: {               master: 12.4 }, name: "デリヘル呼んだら君が来た" },
    { id: 374, difficulty: { expert: 10.0, master: 12.6 }, name: "チュルリラ・チュルリラ・ダッダッダ！" },
    { id: 375, difficulty: {               master: 11.5 }, name: "だんだん早くなる" },
    { id: 376, difficulty: { expert:  9.7, master: 12.2 }, name: "ECHO" },
    { id: 377, difficulty: { expert:  8.4, master: 11.5 }, name: "泡沫、哀のまほろば" },
    { id: 379, difficulty: { expert:  8.3, master: 12.0 }, name: "愛き夜道 feat. ランコ、雨天決行" },
    ...
    { id: 384, difficulty: { expert: 10.0, master: 12.4 }, name: "キュアリアス光吉古牌　－祭－" },
    ...
    { id: 391, difficulty: { expert:  8.5, master: 11.5 }, name: "オモイヨシノ" },
    { id: 393, difficulty: { expert: 11.7, master: 13.8 }, name: "Dengeki Tube" },
    { id: 394, difficulty: { expert:  8.6, master: 11.7 }, name: "若い力 -SEGA HARD GIRLS MIX-" },
    { id: 395, difficulty: { expert:  8.2, master: 11.9 }, name: "レッツゴー!陰陽師" },
    ...
    { id: 399, difficulty: { expert:  9.7, master: 12.6 }, name: "最愛テトラグラマトン" },
    { id: 402, difficulty: { expert:  9.6, master: 12.2 }, name: "悪戯" },
    { id: 403, difficulty: { expert:  8.5, master: 11.2 }, name: "りばーぶ" },
    { id: 404, difficulty: { expert:  9.4, master: 12.0 }, name: "Barbed Eye" },
    { id: 405, difficulty: { expert: 10.7, master: 13.2 }, name: "分からない" },
    { id: 406, difficulty: { expert:  9.8, master: 12.4 }, name: "相思創愛" },
    ...
    { id: 424, difficulty: { expert:  8.5, master: 11.6 }, name: "MIRU key way" },
    { id: 426, difficulty: {               master: 11.5 }, name: "華鳥風月" },
    { id: 427, difficulty: { expert:  9.9, master: 12.5 }, name: "儚きもの人間" },
    { id: 430, difficulty: { expert:  9.8, master: 12.1 }, name: "ＧＯ！ＧＯ！ラブリズム♥ ～あーりん書類審査通過記念Ver.～" },
    { id: 431, difficulty: { expert: 10.0, master: 12.6 }, name: "Session High⤴" },
    { id: 432, difficulty: {               master: 12.3 }, name: "光線チューニング" },
    { id: 433, difficulty: { expert:  9.8, master: 13.0 }, name: "立川浄穢捕物帳" },
    { id: 434, difficulty: { expert: 10.1, master: 13.3 }, name: "眠れぬ夜君を想フ" },
    { id: 435, difficulty: { expert: 11.4, master: 13.3 }, name: "JIGOKU STATION CENTRAL GATE" },
    { id: 436, difficulty: { expert: 10.1, master: 12.5 }, name: "PinqPiq" },
    { id: 437, difficulty: { expert: 10.0, master: 13.2 }, name: "トリスメギストス" },
    { id: 438, difficulty: { expert:  8.7, master: 12.2 }, name: "WE GOTTA SOUL" },
    { id: 439, difficulty: {               master: 12.0 }, name: "哀しみ集め" },
    { id: 440, difficulty: { expert:  9.7, master: 12.9 }, name: "キラメケ→Shoot it Now!" },
    ...
    { id: 445, difficulty: { expert:  8.3, master: 12.1 }, name: "Palette" },
    { id: 446, difficulty: {               master: 11.8 }, name: "アマツキツネ" },
    { id: 447, difficulty: { expert: 10.4, master: 12.7 }, name: "パーフェクト生命" },
    { id: 448, difficulty: { expert:  9.9, master: 13.3 }, name: "のぼれ！すすめ！高い塔" },
    { id: 449, difficulty: { expert: 10.2, master: 13.2 }, name: "害虫" },
    { id: 454, difficulty: {               master: 12.5 }, name: "ガチャガチャきゅ～と・ふぃぎゅ@メイト" },
    { id: 455, difficulty: {               master: 12.6 }, name: "Vampire" },
    { id: 456, difficulty: { expert:  9.9, master: 12.7 }, name: "ケロ⑨destiny" },
    { id: 457, difficulty: {               master: 12.5 }, name: "Last Moments" },
    { id: 458, difficulty: { expert:  9.7, master: 12.8 }, name: "風に乗せた願い" },
    { id: 459, difficulty: {               master: 12.4 }, name: "天狗の落とし文 feat. ｙｔｒ" },
    { id: 460, difficulty: { expert:  8.4, master: 10.2 }, name: "星色夜空" },
    { id: 462, difficulty: {               master: 12.2 }, name: "物凄い勢いでけーねが物凄いうた" },
    { id: 463, difficulty: { expert:  9.8, master: 12.6 }, name: "Wake up Dreamer" },
    { id: 464, difficulty: { expert: 12.7, master: 14.1 }, name: "World Vanquisher" },
    { id: 465, difficulty: { expert: 12.5, master: 14.0 }, name: "macrocosmos" },
    { id: 466, difficulty: { expert: 11.9, master: 13.7 }, name: "Iudicium" },
    { id: 467, difficulty: { expert: 10.4, master: 13.2 }, name: "Twice up Scenery" },
    { id: 468, difficulty: { expert: 10.6, master: 12.9 }, name: "奏者はただ背中と提琴で語るのみ" },
    ...
    { id: 477, difficulty: { expert:  8.8, master: 11.9 }, name: "炉心融解" },
    { id: 478, difficulty: { expert:  8.6, master: 12.4 }, name: "Fire◎Flower" },
    { id: 479, difficulty: {               master: 12.3 }, name: "卑怯戦隊うろたんだー" },
    { id: 481, difficulty: {               master: 12.5 }, name: "イロトリドリのメロディ" },
    { id: 482, difficulty: { expert:  9.7, master: 12.6 }, name: "セハガガガンバッちゃう！！" },
    { id: 483, difficulty: {               master: 12.5 }, name: "Burning Hearts ～炎のANGEL～" },
    { id: 485, difficulty: { expert:  9.3, master: 11.8 }, name: "Our Fighting" },
    { id: 486, difficulty: { expert: 11.9, master: 13.8 }, name: "VERTeX" },
    { id: 487, difficulty: { expert: 10.8, master: 12.7 }, name: "-OutsideR:RequieM-" },
    { id: 488, difficulty: { expert:  8.4, master: 11.3 }, name: "夢と夢～あの日のメロディ～" },
    { id: 489, difficulty: {               master: 12.5 }, name: "La Baguette Magique" },
    { id: 490, difficulty: { expert: 10.7, master: 12.9 }, name: "bubble attack" },
    { id: 491, difficulty: { expert:  9.8, master: 12.5 }, name: "The Darkness of Valhalla" },
    { id: 492, difficulty: { expert:  9.8, master: 12.7 }, name: "時の冒険者" },
    { id: 493, difficulty: { expert: 10.5, master: 12.5 }, name: "Rendezvous" },
    { id: 494, difficulty: {               master: 12.7 }, name: "EXECUTOR" },
    { id: 495, difficulty: { expert:  9.5, master: 12.1 }, name: "不安定な神様" },
    { id: 496, difficulty: { expert: 10.7, master: 13.3 }, name: "Hyper Active" },
    { id: 497, difficulty: { expert:  9.8, master: 12.5 }, name: "L'épilogue" },
    ...
    { id: 500, difficulty: { expert:  8.5, master: 11.7 }, name: "プリズム" },
    { id: 501, difficulty: { expert:  8.6, master: 11.5 }, name: "星灯" },
    ...
    { id: 505, difficulty: { expert:  9.0, master: 11.9 }, name: "Melody！" },
    { id: 506, difficulty: { expert: 12.4, master: 13.6 }, name: "G e n g a o z o" },
    { id: 509, difficulty: { expert:  9.6, master: 12.1 }, name: "Vitalization" },
    { id: 512, difficulty: {               master: 11.6 }, name: "フラジール" },
    { id: 513, difficulty: { expert:  9.8, master: 12.3 }, name: "Absolunote" },
    { id: 514, difficulty: {               master: 12.4 }, name: "木彫り鯰と右肩ゾンビ" },
    { id: 515, difficulty: {               master: 12.5 }, name: "ヒビカセ" },
    { id: 516, difficulty: { expert:  8.4, master: 12.2 }, name: "WAVE" },
    { id: 522, difficulty: { expert:  8.5, master: 11.9 }, name: "Philosophyz" },
    ...
    { id: 528, difficulty: { expert:  9.8, master: 12.9 }, name: "チルノのパーフェクトさんすう教室　⑨周年バージョン" },
    { id: 529, difficulty: {               master: 11.8 }, name: "プレパレード" },
    { id: 530, difficulty: {               master: 11.5 }, name: "オレンジ" },
    { id: 531, difficulty: { expert:  8.1, master: 10.7 }, name: "ホーリーナイト" },
    { id: 532, difficulty: { expert:  8.8, master: 12.4 }, name: "Cosmic twinkle star" },
    { id: 533, difficulty: { expert:  8.7, master: 12.3 }, name: "終わりなき物語" },
    { id: 534, difficulty: { expert: 10.1, master: 13.3 }, name: "BlazinG AIR" },
    { id: 535, difficulty: { expert:  9.5, master: 12.5 }, name: "Change me" },
    { id: 537, difficulty: {               master: 12.0 }, name: "ハレ晴レユカイ" },
    { id: 538, difficulty: { expert: 12.0, master: 13.8 }, name: "AMAZING MIGHTYYYY!!!!" },
    { id: 540, difficulty: { expert:  8.2, master: 12.3 }, name: "砂の惑星 feat. HATSUNE MIKU" },
    { id: 541, difficulty: {               master: 11.7 }, name: "ヒトリゴト" },
    { id: 542, difficulty: { expert:  8.7, master: 11.6 }, name: "adrenaline!!!" },
    { id: 544, difficulty: {               master: 11.7 }, name: "夢路らびりんす" },
    { id: 545, difficulty: { expert:  8.4, master: 11.4 }, name: "全力バタンキュー" },
    { id: 546, difficulty: { expert:  9.5, master: 12.4 }, name: "Last Proof" },
    { id: 547, difficulty: { expert: 10.0, master: 13.0 }, name: "拝啓ドッペルゲンガー" },
    { id: 548, difficulty: { expert: 12.0, master: 13.8 }, name: "Doppelganger" },
    { id: 549, difficulty: {               master: 11.2 }, name: "色は匂へど散りぬるを" },
    { id: 550, difficulty: { expert:  8.5, master: 11.3 }, name: "ポルカドット" },
    ...
    { id: 554, difficulty: { expert:  8.4, master: 11.6 }, name: "アルカリレットウセイ" },
    { id: 555, difficulty: { expert:  9.2, master: 12.3 }, name: "キレキャリオン" },
    { id: 556, difficulty: { expert:  9.4, master: 11.8 }, name: "グラーヴェ" },
    { id: 557, difficulty: { expert:  9.7, master: 12.5 }, name: "レトロマニア狂想曲" },
    { id: 558, difficulty: { expert:  9.6, master: 12.3 }, name: "イロドリミドリ杯花映塚全一決定戦公式テーマソング『ウソテイ』" },
    { id: 559, difficulty: { expert: 12.4, master: 13.9 }, name: "otorii INNOVATED -[i]3-" },
    { id: 560, difficulty: { expert:  9.2, master: 11.9 }, name: "未来イマジネーション！" },
    { id: 561, difficulty: { expert:  9.7, master: 12.4 }, name: "純情-SAKURA-" },
    { id: 562, difficulty: { expert:  9.0, master: 12.5 }, name: "青春サイダー" },
    { id: 564, difficulty: { expert:  9.4, master: 12.3 }, name: "Very! Merry!! Session!!!" },
    { id: 565, difficulty: { expert:  9.7, master: 11.9 }, name: "popcorn" },
    { id: 566, difficulty: { expert: 10.7, master: 12.9 }, name: "Pastel Party" },
    { id: 567, difficulty: { expert:  9.3, master: 12.4 }, name: "はちみつアドベンチャー" },
    { id: 568, difficulty: { expert: 10.9, master: 13.4 }, name: "CHOCOLATE BOMB!!!!" },
    { id: 569, difficulty: { expert: 11.3, master: 13.6 }, name: "Twilight" },
    { id: 570, difficulty: { expert: 12.4, master: 13.8 }, name: "ねぇ、壊れタ人形ハ何処へ棄テらレるノ？" },
    { id: 572, difficulty: { expert:  9.7, master: 12.4 }, name: "WARNING×WARNING×WARNING" },
    { id: 574, difficulty: {               master: 12.0 }, name: "ネ！コ！" },
    { id: 575, difficulty: { expert:  9.3, master: 12.2 }, name: "マトリョシカ" },
    { id: 577, difficulty: { expert:  9.7, master: 12.5 }, name: "ゴーゴー幽霊船" },
    { id: 578, difficulty: { expert:  9.1, master: 12.5 }, name: "La Flesvelka" },
    { id: 579, difficulty: { expert:  9.2, master: 11.9 }, name: "羽ばたきのバースデイ" },
    { id: 580, difficulty: { expert:  9.6, master: 12.4 }, name: "楔" },
    { id: 581, difficulty: { expert:  9.7, master: 12.3 }, name: "Los! Los! Los!" },
    { id: 582, difficulty: { expert:  9.4, master: 12.4 }, name: "Uncontrollable" },
    { id: 583, difficulty: { expert:  9.2, master: 12.8 }, name: "碧き孤島のアングゥィス" },
    { id: 585, difficulty: {               master: 12.7 }, name: "ラブって♡ジュエリー♪えんじぇる☆ブレイク！！" },
    { id: 586, difficulty: {               master: 12.4 }, name: "ぶれいくるみるくらぶ！" },
    { id: 587, difficulty: { expert:  9.1, master: 12.4 }, name: "クレッシェンド・ストーリー" },
    { id: 588, difficulty: { expert:  8.0, master: 11.5 }, name: "Sentimental Snow" },
    { id: 589, difficulty: { expert: 10.6, master: 12.9 }, name: "サンシャインサマー☆夏期講習" },
    { id: 590, difficulty: { expert: 10.7, master: 12.6 }, name: "NYAN-NYA, More! ラブシャイン、Chu♥" },
    { id: 591, difficulty: { expert:  8.8, master: 11.8 }, name: "ガヴリールドロップキック" },
    { id: 592, difficulty: { expert:  9.4, master: 12.5 }, name: "厨病激発ボーイ" },
    ...
    { id: 597, difficulty: { expert:  9.2, master: 11.6 }, name: "TOMORROW" },
    { id: 599, difficulty: { expert:  9.4, master: 11.1 }, name: "Chocolate Happy" },
    ...
    { id: 605, difficulty: { expert:  9.7, master: 12.4 }, name: "Scream out! -CHUNITHM Tuning-" },
    { id: 606, difficulty: { expert:  8.8, master: 12.2 }, name: "Spring of Dreams" },
    { id: 607, difficulty: { expert:  9.5, master: 12.7 }, name: "Floating Darkness" },
    { id: 609, difficulty: { expert:  9.2, master: 12.4 }, name: "あ・え・い・う・え・お・あお!!" },
    { id: 610, difficulty: { expert:  8.9, master: 11.9 }, name: "かーてんこーる!!!!!" },
    ...
    { id: 614, difficulty: { expert:  8.9, master: 12.5 }, name: "Change Our MIRAI！ (Our 7 Lights)" },
    { id: 615, difficulty: { expert: 10.8, master: 12.8 }, name: "Dual Fractal" },
    { id: 616, difficulty: { expert: 11.3, master: 12.8 }, name: "Drivessover" },
    { id: 617, difficulty: { expert: 11.9, master: 13.9 }, name: "Surveiller et punir" },
    { id: 618, difficulty: { expert: 13.0, master: 14.1 }, name: "業 -善なる神とこの世の悪について-" },
    { id: 620, difficulty: { expert:  8.7, master: 12.3 }, name: "メニメニマニマニ" },
    { id: 621, difficulty: { expert:  9.1, master: 11.6 }, name: "ニホンゴワカリマセン" },
    { id: 622, difficulty: { expert:  9.0, master: 11.4 }, name: "Get goal!" },
    { id: 623, difficulty: { expert:  8.5, master: 11.9 }, name: "Rolling Rolling!" },
    { id: 624, difficulty: { expert:  8.8, master: 12.1 }, name: "灼熱スイッチ" },
    { id: 625, difficulty: { expert: 12.4, master: 13.5 }, name: "volcanic" },
    ...
    { id: 631, difficulty: { expert: 12.4, master: 13.7 }, name: "初音ミクの激唱" },
    { id: 632, difficulty: { expert:  8.8, master: 12.4 }, name: "つるぺったん" },
    { id: 633, difficulty: { expert:  9.2, master: 12.4 }, name: "咲キ誇レ常世ノ華" },
    { id: 635, difficulty: { expert:  9.9, master: 12.6 }, name: "チルノおかんのさいきょう☆バイブスごはん" },
